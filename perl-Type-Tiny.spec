...
Source0  : https://cpan.metacpan.org/authors/id/T/TO/TOBYINK/Type-Tiny-1.012002.tar.gz
...
%prep
%setup -q -n Type-Tiny-1.012002
cd %{_builddir}/Type-Tiny-1.012002
...
cp %{_builddir}/Type-Tiny-1.012002/LICENSE %{buildroot}/usr/share/package-licenses/perl-Type-Tiny/314b5ed5370f5eb5b7e186d7f095c1c12060a731
if test -f Makefile.PL; then
