...
Source0  : https://cpan.metacpan.org/authors/id/T/TO/TOBYINK/Type-Tiny-1.016000.tar.gz
...
%prep
%setup -q -n Type-Tiny-1.016000
cd %{_builddir}/Type-Tiny-1.016000
...
cp %{_builddir}/Type-Tiny-1.016000/LICENSE %{buildroot}/usr/share/package-licenses/perl-Type-Tiny/b288b1bcff3334631a50e17207149b915027c134
if test -f Makefile.PL; then
