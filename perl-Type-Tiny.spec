...
Source0  : https://cpan.metacpan.org/authors/id/T/TO/TOBYINK/Type-Tiny-1.010004.tar.gz
...
%prep
%setup -q -n Type-Tiny-1.010004
cd %{_builddir}/Type-Tiny-1.010004
...
cp %{_builddir}/Type-Tiny-1.010004/LICENSE %{buildroot}/usr/share/package-licenses/perl-Type-Tiny/fe949ecf1e34d3c41d26feec5553d225755faf79
if test -f Makefile.PL; then
