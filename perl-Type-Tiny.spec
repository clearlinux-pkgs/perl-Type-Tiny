...
Source0  : https://cpan.metacpan.org/authors/id/T/TO/TOBYINK/Type-Tiny-2.008001.tar.gz
...
%prep
%setup -q -n Type-Tiny-2.008001
cd %{_builddir}/Type-Tiny-2.008001
pushd ..
cp -a Type-Tiny-2.008001 buildavx2
popd
...
cp %{_builddir}/Type-Tiny-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Type-Tiny/9ed5f64fd54210fc6e06dc10e80b102041ab435c || :
if test -f Makefile.PL; then
...
/usr/share/man/man3/Type::Params::Alternatives.3
/usr/share/man/man3/Type::Params::Parameter.3
/usr/share/man/man3/Type::Params::Signature.3
...
/usr/share/package-licenses/perl-Type-Tiny/9ed5f64fd54210fc6e06dc10e80b102041ab435c
