...
Source0  : https://cpan.metacpan.org/authors/id/T/TO/TOBYINK/Type-Tiny-1.016003.tar.gz
...
%prep
%setup -q -n Type-Tiny-1.016003
cd %{_builddir}/Type-Tiny-1.016003
...
cp %{_builddir}/Type-Tiny-1.016003/LICENSE %{buildroot}/usr/share/package-licenses/perl-Type-Tiny/b288b1bcff3334631a50e17207149b915027c134
if test -f Makefile.PL; then
