...
Source0  : https://cpan.metacpan.org/authors/id/T/TO/TOBYINK/Type-Tiny-2.006000.tar.gz
...
%prep
%setup -q -n Type-Tiny-2.006000
cd %{_builddir}/Type-Tiny-2.006000
pushd ..
cp -a Type-Tiny-2.006000 buildavx2
popd
...
cp %{_builddir}/Type-Tiny-%{version}/COPYRIGHT %{buildroot}/usr/share/package-licenses/perl-Type-Tiny/a38a633a488c7dbf93a8e8d0237214f668847af8 || :
cp %{_builddir}/Type-Tiny-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Type-Tiny/aee2dc69fc97a9da3f9af0cde39cb099b2d1becd || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-Type-Tiny/a38a633a488c7dbf93a8e8d0237214f668847af8
/usr/share/package-licenses/perl-Type-Tiny/aee2dc69fc97a9da3f9af0cde39cb099b2d1becd
