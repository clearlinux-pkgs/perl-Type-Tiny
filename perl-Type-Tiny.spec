...
Source0  : https://cpan.metacpan.org/authors/id/T/TO/TOBYINK/Type-Tiny-2.008000.tar.gz
...
%prep
%setup -q -n Type-Tiny-2.008000
cd %{_builddir}/Type-Tiny-2.008000
pushd ..
cp -a Type-Tiny-2.008000 buildavx2
popd
